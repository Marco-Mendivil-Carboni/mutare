...
First we will consider the following \emph{symmetric} parameters:
\begin{itemize}
    ...
    \item $N_0=100$
\end{itemize}
In \autoref{fig:symmetric_strat_phe} we show the results of the simulations with this parameters for different initial strategies. And in \autoref{fig:symmetric_prob_mut} we show the results of some simulations with this same parameters but a varying mutation probability and a random initial condition.
...
Next we will consider the following \emph{asymmetric} parameters:
\begin{itemize}
...
\end{itemize}
In \autoref{fig:asymmetric_strat_phe} we show the results of the simulations with this parameters for different initial strategies. And in \autoref{fig:asymmetric_prob_mut} we show the results of some simulations with this same parameters but a varying mutation probability and a random initial condition.
...
% In \autoref{fig:results_extended} we show the results for the \emph{extended} parameters:
% \begin{itemize}
%     \item $N_0=1000$
