...
\begin{figure*}[p]
    \centering
    \caption{Results for the symmetric parameters.} \label{fig:symmetric_strat_phe_0}
...
\begin{figure*}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:asymmetric_strat_phe_0}
...
\begin{figure*}[p]
    \centering
    \caption{Results for the extended parameters.} \label{fig:extended_strat_phe_0}
