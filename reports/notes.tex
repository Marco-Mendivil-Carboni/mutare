...
We will consider two possible types of initial conditions, one in which all the population has the same strategy and one in which each agent has a different random strategy.

\section{Results: phenotipic diversity and safe strategies} \label{sec:results}

In \autoref{fig:symmetric_strat_phe}, \autoref{fig:symmetric_prob_mut} and \autoref{fig:symmetric_n_agents} we show the results for the following \emph{symmetric} parameters:
\begin{itemize}
...
\begin{figure*}[p]
    \centering
    \caption{Results for the symmetric parameters.} \label{fig:symmetric_strat_phe}
    ...
    \includegraphics{../sims/symmetric/plots/strat_phe/rates.pdf}
\end{figure*}

\begin{figure*}[p]
    \centering
    \caption{Results for the symmetric parameters.} \label{fig:symmetric_prob_mut}
...
\begin{figure*}[p]
    \centering
    \caption{Results for the symmetric parameters.} \label{fig:symmetric_n_agents}
    ...
    \includegraphics{../sims/symmetric/plots/n_agents/avg_strat_phe.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents/dist_strat_phe.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents/rates.pdf}
\end{figure*}

In \autoref{fig:asymmetric_strat_phe}, \autoref{fig:asymmetric_prob_mut} and \autoref{fig:asymmetric_n_agents} we show the results for the following \emph{asymmetric} parameters:
\begin{itemize}
...
\begin{figure*}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:asymmetric_strat_phe}
    ...
    \includegraphics{../sims/asymmetric/plots/strat_phe/rates.pdf}
\end{figure*}

\begin{figure*}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:asymmetric_prob_mut}
    ...
    \includegraphics{../sims/asymmetric/plots/prob_mut/avg_strat_phe.pdf}
    \includegraphics{../sims/asymmetric/plots/prob_mut/dist_strat_phe.pdf}
    \includegraphics{../sims/asymmetric/plots/prob_mut/rates.pdf}
\end{figure*}

\begin{figure*}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:asymmetric_n_agents}
    ...
    \includegraphics{../sims/asymmetric/plots/n_agents/avg_strat_phe.pdf}
    \includegraphics{../sims/asymmetric/plots/n_agents/dist_strat_phe.pdf}
    \includegraphics{../sims/asymmetric/plots/n_agents/rates.pdf}
\end{figure*}

In \autoref{fig:extended_strat_phe} we show the results for the following \emph{extended} parameters:
\begin{itemize}
    \item $N_0=1000$
...
\begin{figure*}[p]
    \centering
    \caption{Results for the extended parameters.} \label{fig:extended_strat_phe}
    ...
    \includegraphics{../sims/extended/plots/strat_phe/rates.pdf}
\end{figure*}
