...
\begin{itemize}
    ...
    \item $N_0=100$
\end{itemize}
In \autoref{fig:symmetric_strat_phe} we show the results of the simulations with this parameters for different initial strategies.
...
In \autoref{fig:results_asymmetric} we show the results for the \emph{asymmetric} parameters:
\begin{itemize}
...
\begin{figure}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:results_asymmetric}
...
\begin{figure}[p]
    \centering
    \caption{Results for the asymmetric parameters.} \label{fig:results_asymmetric_}
