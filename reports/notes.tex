...
In \autoref{fig:extinct_rate_symmetric}, \autoref{fig:growth_rate_symmetric}, \autoref{fig:avg_strat_phe_symmetric} and \autoref{fig:dist_strat_phe_symmetric} we show the results for the following \emph{symmetric} parameters:
\begin{itemize}
...
In \autoref{fig:extinct_rate_asymmetric}, \autoref{fig:growth_rate_asymmetric}, \autoref{fig:avg_strat_phe_asymmetric} and \autoref{fig:dist_strat_phe_asymmetric} we show the results for the \emph{asymmetric} parameters:
\begin{itemize}
...
\begin{figure}[p]
    \centering
    \caption{Extinction rate as a function of growth rate for the symmetric parameters.} \label{fig:extinct_rate_symmetric}
    \includegraphics{../sims/symmetric/plots/strat_phe/extinct_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Growth rate as a function of the initial strategy for the symmetric parameters.} \label{fig:growth_rate_symmetric}
    \includegraphics{../sims/symmetric/plots/strat_phe/growth_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Average strategy as a function of the initial strategy for the symmetric parameters.} \label{fig:avg_strat_phe_symmetric}
    \includegraphics{../sims/symmetric/plots/strat_phe/avg_strat_phe.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Strategy distribution as a function of the initial strategy for the symmetric parameters.} \label{fig:dist_strat_phe_symmetric}
    \includegraphics{../sims/symmetric/plots/strat_phe/dist_strat_phe.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Extinction rate as a function of growth rate for the asymmetric parameters.} \label{fig:extinct_rate_asymmetric}
    \includegraphics{../sims/asymmetric/plots/strat_phe/extinct_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Growth rate as a function of the initial strategy for the asymmetric parameters.} \label{fig:growth_rate_asymmetric}
    \includegraphics{../sims/asymmetric/plots/strat_phe/growth_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Average strategy as a function of the initial strategy for the asymmetric parameters.} \label{fig:avg_strat_phe_asymmetric}
    \includegraphics{../sims/asymmetric/plots/strat_phe/avg_strat_phe.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Strategy distribution as a function of the initial strategy for the asymmetric parameters.} \label{fig:dist_strat_phe_asymmetric}
    \includegraphics{../sims/asymmetric/plots/strat_phe/dist_strat_phe.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Extinction rate as a function of growth rate for the extended parameters.} \label{fig:extinct_rate_extended}
    \includegraphics{../sims/extended/plots/strat_phe/extinct_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Growth rate as a function of the initial strategy for the extended parameters.} \label{fig:growth_rate_extended}
    \includegraphics{../sims/extended/plots/strat_phe/growth_rate.pdf}
\end{figure}
...
\begin{figure}[p]
    ...
    \includegraphics{../sims/extended/plots/strat_phe/avg_strat_phe.pdf}
\end{figure}
...
\begin{figure}[p]
    ...
    \includegraphics{../sims/extended/plots/strat_phe/dist_strat_phe.pdf}
\end{figure}

% And finally in \autoref{fig:extinct_rate_prob_mut}, \autoref{fig:growth_rate_prob_mut}, \autoref{fig:avg_strat_phe_prob_mut} and \autoref{fig:dist_strat_phe_prob_mut} we show some other results for the \emph{symmetric} parameters (modifying the mutation probability).

% \begin{figure}[p]
%     \centering
%     \caption{Extinction rate as a function of the mutation probability for the symmetric parameters.} \label{fig:extinct_rate_prob_mut}
%     \includegraphics{../sims/symmetric/plots/prob_mut/extinct_rate.pdf}
% \end{figure}

% \begin{figure}[p]
%     \centering
%     \caption{Growth rate as a function of the mutation probability for the symmetric parameters.} \label{fig:growth_rate_prob_mut}
%     \includegraphics{../sims/symmetric/plots/prob_mut/growth_rate.pdf}
% \end{figure}

% \begin{figure}[p]
%     \centering
%     \caption{Average strategy as a function of the mutation probability for the symmetric parameters.} \label{fig:avg_strat_phe_prob_mut}
%     \includegraphics{../sims/symmetric/plots/prob_mut/avg_strat_phe.pdf}
% \end{figure}

% \begin{figure}[p]
%     \centering
%     \caption{Strategy distribution as a function of the mutation probability for the symmetric parameters.} \label{fig:dist_strat_phe_prob_mut}
%     \includegraphics{../sims/symmetric/plots/prob_mut/dist_strat_phe.pdf}
% \end{figure}
