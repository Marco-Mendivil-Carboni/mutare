...
\begin{figure}[p]
    ...
    \includegraphics{../plots/sims/symmetric/avg_strat_phe.pdf}
\end{figure}
...
\begin{figure}[p]
    ...
    \includegraphics{../plots/sims/asymmetric/avg_strat_phe.pdf}
\end{figure}
...
\begin{figure}[p]
    ...
    \includegraphics{../plots/sims/asymmetric/dist_strat_phe.pdf}
\end{figure}
...
And finally in \autoref{fig:extinct_rate_prob_mut}, \autoref{fig:growth_rate_prob_mut}, \autoref{fig:avg_strat_phe_prob_mut} and \autoref{fig:dist_strat_phe_prob_mut} we show some other results for the \emph{asymmetric} parameters (modifying the mutation probability).

\begin{figure}[p]
    \centering
    \caption{Extinction rate as a function of the mutation probability for the asymmetric parameters.} \label{fig:extinct_rate_prob_mut}
    \includegraphics{../plots/sims/prob_mut/extinct_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Growth rate as a function of the mutation probability for the asymmetric parameters.} \label{fig:growth_rate_prob_mut}
    \includegraphics{../plots/sims/prob_mut/growth_rate.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Average strategy as a function of the mutation probability for the asymmetric parameters.} \label{fig:avg_strat_phe_prob_mut}
    \includegraphics{../plots/sims/prob_mut/avg_strat_phe.pdf}
\end{figure}

\begin{figure}[p]
    \centering
    \caption{Strategy distribution as a function of the mutation probability for the asymmetric parameters.} \label{fig:dist_strat_phe_prob_mut}
    \includegraphics{../plots/sims/prob_mut/dist_strat_phe.pdf}
\end{figure}
