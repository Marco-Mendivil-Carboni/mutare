...
\begin{frame}
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      \begin{figure}
        \frame{\includegraphics[scale=0.75]{../sims/asymmetric/plots/strat_phe_0_i/avg_avg_strat_phe_0.pdf}}
      \end{figure}
    \end{column}
  \end{columns}
  \vfill
...
\begin{frame}
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      \begin{figure}
        \frame{\includegraphics[scale=0.75]{../sims/asymmetric/plots/n_agents_i/avg_avg_strat_phe_0.pdf}}
      \end{figure}
      \begin{figure}
        \frame{\includegraphics[scale=0.75]{../sims/asymmetric/plots/prob_mut/avg_avg_strat_phe_0.pdf}}
      \end{figure}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{Heuristic approximation}
        ...
        \begin{equation*}
          p(s)\propto\frac{\exp\left(N_\text{ini}\langle\mu(s)\rangle\right)}{r_{\text{ext}}(s)+p_{\text{mut}}\langle\mu_b(s)\rangle}
        \end{equation*}
      \end{block}
    ...
    \begin{column}{0.55\textwidth}
      \begin{figure}
        \frame{\includegraphics[scale=0.66]{../sims/asymmetric/plots/fixed/exp_avg_avg_strat_phe_0.pdf}}
        \caption*{\footnotesize Expected average strategy}
        \frame{\includegraphics[scale=0.66]{../sims/asymmetric/plots/fixed/avg_avg_strat_phe_0.pdf}}
...
\begin{frame}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \frame{\includegraphics[scale=0.75]{../sims/symmetric/plots/strat_phe_0_i/avg_avg_strat_phe_0.pdf}}
      \end{figure}
      \begin{figure}
        \frame{\includegraphics[scale=0.75]{../sims/symmetric/plots/n_agents_i/avg_avg_strat_phe_0.pdf}}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \begin{figure}
    \frame{\includegraphics[scale=0.75]{../sims/incremental/plots/strat_phe_0_i/avg_avg_strat_phe_0.pdf}}
  \end{figure}
  \begin{figure}
    \frame{\includegraphics[scale=0.75]{../sims/incremental/plots/n_agents_i/avg_avg_strat_phe_0.pdf}}
  \end{figure}
\end{frame}
