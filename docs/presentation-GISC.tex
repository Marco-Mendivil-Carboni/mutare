...
\begin{frame}{Symmetric parameters}
  \begin{figure}
    \centering
    \frame{\includegraphics{../sims/symmetric/plots/strat_phe_0_i/rates.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}{Symmetric parameters}
  \begin{figure}
    \centering
    \frame{\includegraphics{../sims/symmetric/plots/strat_phe_0_i/avg_strat_phe_0.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}{Symmetric parameters}
  \begin{figure}
    \centering
    \frame{\includegraphics{../sims/symmetric/plots/n_agents_i/avg_strat_phe_0.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}{Symmetric parameters}
  \begin{figure}
    \centering
    \frame{\includegraphics{../sims/symmetric/plots/strat_phe_0_i/dist_phe_0.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}{Symmetric parameters}
  \begin{figure}
    \centering
    \frame{\includegraphics{../sims/symmetric/plots/strat_phe_0_i/fitness.pdf}}
  \end{figure}
\end{frame}
