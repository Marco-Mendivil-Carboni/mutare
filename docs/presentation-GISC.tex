...
\begin{frame}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{block}{Observables}
        \begin{itemize}
          ...
          \item Total extinction rate $r_e$ ($n_e$)
          \item Distribution of phenotypic strategies $p(s(0))$, Average phenotypic strategy $\langle s(0)\rangle$
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \frame{\includegraphics[scale=0.7]{../sims/asymmetric/plots/strat_phe_0_i/avg_growth_rate.pdf}}
      \end{figure}
      \begin{figure}
        \frame{\includegraphics[scale=0.7]{../sims/asymmetric/plots/strat_phe_0_i/extinct_rate.pdf}}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  \begin{minipage}{0.42\textwidth}
    Some more text explaining the main results...
  \end{minipage}
  \begin{minipage}{0.54\textwidth}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/dist_strat_phe_0.pdf}}
    \end{figure}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/avg_strat_phe_0.pdf}}
    \end{figure}
  \end{minipage}
\end{frame}
...
\begin{frame}
  \begin{minipage}{0.42\textwidth}
    Some more text explaining this auxiliary results...
  \end{minipage}
  \hfill
  \begin{minipage}{0.54\textwidth}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/dist_n_agents.pdf}}
    \end{figure}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/dist_phe_0.pdf}}
    \end{figure}
  \end{minipage}
\end{frame}
...
\begin{frame}
  \begin{minipage}{0.42\textwidth}
    Some more text explaining the time series
  \end{minipage}
  \hfill
  \begin{minipage}{0.54\textwidth}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/time_series/avg_strat_phe_0.pdf}}
    \end{figure}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/time_series/n_extinct.pdf}}
    \end{figure}
  \end{minipage}
\end{frame}
...
\begin{frame}
  \begin{minipage}{0.42\textwidth}
    Some more text explaining the extended case...
  \end{minipage}
  \hfill
  \begin{minipage}{0.54\textwidth}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/extended/plots/strat_phe_0_i/dist_strat_phe_0.pdf}}
    \end{figure}
    \begin{figure}
