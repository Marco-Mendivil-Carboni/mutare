...
\begin{frame}
  \begin{block}{State}
    \begin{itemize}
      ...
      \item \alert{Population}: $N\le N_i$ agents, each one characterized by:
            \begin{itemize}
  ...
  \note[item]{Continuous-time Markov process describing a population evolving in a fluctuating environment.}
...
\begin{frame}
  ...
  Add block explaining simulation types...
