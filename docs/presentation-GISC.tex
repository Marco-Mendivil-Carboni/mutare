...
\begin{frame}
  \begin{minipage}{0.42\textwidth}
    ...
    \end{block}
    \begin{figure}
      \frame{\includegraphics[scale=0.6]{../sims/asymmetric/plots/strat_phe_0_i/rates.pdf}}
    \end{figure}
  \end{minipage}
  \hfill
  \begin{minipage}{0.54\textwidth}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/avg_growth_rate.pdf}}
    \end{figure}
    \begin{figure}
      \frame{\includegraphics[scale=0.8]{../sims/asymmetric/plots/strat_phe_0_i/extinct_rate.pdf}}
    \end{figure}
  \end{minipage}
