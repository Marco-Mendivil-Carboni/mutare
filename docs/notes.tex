...
\begin{figure*}[p]
    ...
    \includegraphics{../sims/symmetric/plots/scaling/ext_fit_k.pdf}
\end{figure*}

\begin{figure*}[p]
    \centering
    \caption{Results for the scaling with the symmetric parameters.} \label{fig:symmetric_scaling_2}
    \includegraphics{../sims/symmetric/plots/scaling/exp_dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/scaling/dist_avg_strat_phe_0.pdf}
\end{figure*}
...
\begin{figure*}[p]
    ...
    \includegraphics{../sims/asymmetric/plots/scaling/ext_fit_k.pdf}
\end{figure*}

\begin{figure*}[p]
    \centering
    \caption{Results for the scaling with the asymmetric parameters.} \label{fig:asymmetric_scaling_2}
    \includegraphics{../sims/asymmetric/plots/scaling/exp_dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/asymmetric/plots/scaling/dist_avg_strat_phe_0.pdf}
\end{figure*}
