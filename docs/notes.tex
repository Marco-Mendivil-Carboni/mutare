...
Additional support for the relevance of a quasi-monomorphic description comes from the observation that, for sufficiently small mutation probabilities, the extinction rate measured in the random simulations is accurately approximated by
\begin{equation}
    r_{\text{ext}} \approx \int ds\, p(s)\, r_{\text{ext}}(s),
\end{equation}
as shown by the dash--dotted gray lines in the extinction panels of \autoref{fig:symmetric_prob_mut} and \autoref{fig:asymmetric_prob_mut}. This agreement indicates that extinction events typically occur while the population is close to a single, well-defined strategy, and that the apparent broadness of the strategy distribution arises primarily from averaging over different realizations and over long times.

Finally, simulations performed with larger populations ($N_i=1000$) show that, in this regime, the results depend only weakly on the mutation probability, aside from statistical noise. This insensitivity is in itself significant: it indicates that, for sufficiently large populations, the evolutionary outcome is robust and predictable, and that the pronounced dependence on $p_{\mathrm{mut}}$ observed at $N_i=100$ is a finite-size effect. At the same time, these finite-size effects remain biologically and theoretically interesting, as they modulate the crossover between extinction-dominated and growth-dominated evolutionary regimes.

COMMENT THAT $N_{\text{ini}}^{-\langle\mu\rangle/\sigma_\mu^2}$ IS KIND OF SIMILAR TO $r_ext$ BUT DOES NOT COINCIDE IN THE SCALE AT ALL (VARIES TOO MUCH IN SCALE).

\section{Discussion and outlook} \label{sec:discussion}

The numerical results presented here naturally raise the question of what quantity evolution is effectively optimizing in finite populations subject to demographic stochasticity and environmental fluctuations. While classical evolutionary theory predicts maximization of long-term growth rate in large populations, our results suggest that this principle breaks down once extinction becomes a relevant event. In particular, the observed convergence toward safer, lower-growth strategies at small population sizes points to the existence of an alternative optimization principle that explicitly incorporates extinction risk. Identifying such a principle, and understanding how it interpolates between growth maximization and extinction avoidance as population size varies, remains an important open problem. Some possible expresions for the fitness are:
\begin{equation} \label{eq:effective_fitness}
    \mu-\frac{1}{2}\sigma_\mu^2, \ \mu-\frac{1}{N_i}\sigma_\mu^2 \ \& \ \mu-N_i\cdot r_e.
\end{equation}
The last expression is the one suggest and the one I use in the figures although I do not know yet how to justify it, while the first two were proposed by Gillespie.
...
\begin{equation}
    p(s)\propto\frac{\exp(N_\text{ini}\cdot\langle\mu(s)\rangle)}{r_{\text{ext}}(N_\text{ini},s)+p_\text{mut}\langle\mu_b\rangle},
...
COMMENT how we consider that for $p_\text{mut}>0$ we can add to \autoref{eq:heuristic_distribution} a term to the denominator which represents the rate at which a strategy dissapears, not because the population goes extinct as a whole but beacuse a particular mutation has fixed in the population.
...
Incorporating the effect of small but nonzero values of $p_{\text{mut}}$ into \autoref{eq:heuristic_distribution} remains an open problem. In particular, extending the approximation to account for the increasing bias toward growth-maximizing strategies observed as $p_{\text{mut}}$ increases (while remaining $\ll 1$) is a natural direction for future work.

\section{More than two environments and phenotypes}

We suspect in this case there will still be a unique maxima to the growth rate and a unique minima to the extinction rate, more precisely we believe this functions will be concave and convex respectively, but we have not proven it.
...
\begin{figure*}[p]
    ...
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/avg_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/avg_birth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/strat_phe_0_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    ...
    \includegraphics{../sims/symmetric/plots/prob_mut/dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/prob_mut/avg_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/prob_mut/avg_dist_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/prob_mut/std_dev_growth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/prob_mut/avg_birth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/prob_mut/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    ...
    \includegraphics{../sims/symmetric/plots/n_agents_i/dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents_i/avg_avg_strat_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents_i/avg_birth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/n_agents_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
...
\begin{figure*}[p]
    \centering
    \caption{Results for the fixed simulations with the symmetric parameters.} \label{fig:symmetric_fixed}
    \includegraphics{../sims/symmetric/plots/fixed/avg_growth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/fixed/extinct_rate.pdf}
    \includegraphics{../sims/symmetric/plots/fixed/avg_dist_phe_0.pdf}
    \includegraphics{../sims/symmetric/plots/fixed/std_dev_growth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/fixed/avg_birth_rate.pdf}
    \includegraphics{../sims/symmetric/plots/fixed/extinct_rate_scaling.pdf}
...
\begin{figure*}[p]
    ...
    \includegraphics{../sims/asymmetric/plots/prob_mut/avg_dist_phe_0.pdf}
    \includegraphics{../sims/asymmetric/plots/prob_mut/std_dev_growth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/prob_mut/avg_birth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/prob_mut/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    ...
    \includegraphics{../sims/asymmetric/plots/n_agents_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/asymmetric/plots/n_agents_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/n_agents_i/avg_birth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/n_agents_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
...
\begin{figure*}[p]
    \centering
    \caption{Results for the fixed simulations with the asymmetric parameters.} \label{fig:asymmetric_fixed}
    \includegraphics{../sims/asymmetric/plots/fixed/avg_growth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/fixed/extinct_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/fixed/avg_dist_phe_0.pdf}
    \includegraphics{../sims/asymmetric/plots/fixed/std_dev_growth_rate.pdf}
    \includegraphics{../sims/asymmetric/plots/fixed/avg_birth_rate.pdf}
...
\begin{figure*}[p]
    ...
    \includegraphics{../sims/extended/plots/strat_phe_0_i/dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/extended/plots/strat_phe_0_i/avg_avg_strat_phe_0.pdf}
    \includegraphics{../sims/extended/plots/strat_phe_0_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/extended/plots/strat_phe_0_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/extended/plots/strat_phe_0_i/avg_birth_rate.pdf}
    \includegraphics{../sims/extended/plots/strat_phe_0_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    ...
    \includegraphics{../sims/extended/plots/prob_mut/dist_avg_strat_phe_0.pdf}
    \includegraphics{../sims/extended/plots/prob_mut/avg_avg_strat_phe_0.pdf}
    \includegraphics{../sims/extended/plots/prob_mut/avg_dist_phe_0.pdf}
    \includegraphics{../sims/extended/plots/prob_mut/std_dev_growth_rate.pdf}
    \includegraphics{../sims/extended/plots/prob_mut/avg_birth_rate.pdf}
    \includegraphics{../sims/extended/plots/prob_mut/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
...
\begin{figure*}[p]
    \centering
    \caption{Results for the incremental parameters with different initial strategies.} \label{fig:incremental_strat_phe_0_i}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/avg_growth_rate.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/extinct_rate.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/rates.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/dist_n_agents.pdf}
    ...
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/avg_birth_rate.pdf}
    \includegraphics{../sims/incremental/plots/strat_phe_0_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    \caption{Results for the incremental parameters with different numbers of agents.} \label{fig:incremental_n_agents_i}
    \includegraphics{../sims/incremental/plots/n_agents_i/avg_growth_rate.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/extinct_rate.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/rates.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/dist_n_agents.pdf}
    ...
    \includegraphics{../sims/incremental/plots/n_agents_i/avg_dist_phe_0.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/std_dev_growth_rate.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/avg_birth_rate.pdf}
    \includegraphics{../sims/incremental/plots/n_agents_i/growth_rates.pdf}
\end{figure*}
\begin{figure*}[p]
    \centering
    \caption{Results for the incremental parameters as a function of time.} \label{fig:incremental_time_series}
    \includegraphics{../sims/incremental/plots/time_series/n_agents.pdf}
    \includegraphics{../sims/incremental/plots/time_series/n_extinct.pdf}
    \includegraphics{../sims/incremental/plots/time_series/avg_strat_phe_0.pdf}
    \includegraphics{../sims/incremental/plots/time_series/dist_phe_0.pdf}
\end{figure*}
