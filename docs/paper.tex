...
\begin{figure}[t]
    ...
    \caption{Results for incremental mutations. Dependence of the evolved strategy on initial conditions (top) and on population size (bottom). The qualitative behavior matches that of the main model. As previously, the dashed and dotted lines indicate the strategies that maximize mean growth and minimize extinction, respectively.} \label{fig:incremental_mutations}
\end{figure}
