...
\begin{appendices}
    ...
    \begin{figure*}
        ...
        \caption{Distributions of the population-averaged strategy $\bar{s}(A)$ predicted by the heuristic approximation (left) and obtained from \texttt{evol(r)} simulations (right) with the EA parameters for different population sizes $N_\text{ini}$.} \label{fig:strategy_distributions_EA}
    \end{figure*}
    ...
    \begin{figure*}
        ...
        \caption{Expected average strategy from the heuristic distribution $\langle\bar{s}(A)\rangle^\ast$ (left) and observed average strategy from \texttt{evol(r)} simulations (right) for different values of $N_\text{ini}$ and $p_\text{mut}$ with the EA parameters.} \label{fig:heuristic_approx_EA}
    \end{figure*}
