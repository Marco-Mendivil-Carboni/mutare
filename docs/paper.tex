...
\begin{figure}[t]
    ...
    \caption{Dependence of the evolved strategy on initial conditions with $N_\text{ini}=100$ (top) and on population size (bottom) for the PR parameter set with incremental mutations. The qualitative behavior matches that of the main model. As previously, the dashed and dotted lines indicate the strategies that maximize mean growth and minimize extinction, respectively.} \label{fig:incremental_mutations}
\end{figure}
...
\begin{figure}
    ...
    \caption{Dependence of the evolved strategy on initial conditions with $N_\text{ini}=100$ (top) and on population size (bottom) for the EA parameter set. The dashed line indicates the strategy that maximizes mean growth, while the dotted line marks the one that minimizes extinction. The same qualitative trends as in the PR parameter set are observed.} \label{fig:symmetric_parameters}
\end{figure}
