...
Adaptation in fluctuating environments is a central problem in evolutionary biology \cite{gillespieNaturalSelectionVariances1977,kingscollegeRiskUncertaintyEvolutionary1982,kussellPhenotypicDiversityPopulation2005,ashcroftFixationFinitePopulations2014,saakianAlleleFixationProbability2019,camachomateuPhenotypicdependentVariabilityEmergence2021,kaushikTimeFixationChanging2021,collectiveEconomicPrinciplesCell}. Natural populations rarely experience constant conditions: rather, they face environments that change \emph{unpredictably} over time, often on ecological or evolutionary timescales. In such contexts, if sensing the changes in the environment is infeasible or too costly, it is well established in the ecology and population genetics literature that bet-hedging (i.e. investing only a fraction of the population to each possible phenotype) offers a good alternative to adapt to this fluctuating environment \cite{kussellPhenotypicDiversityPopulation2005,huftonPhenotypicSwitchingPopulations2018}.
