...
\end{equation}
In this scenario, each phenotype is highly specialized for one specific environment, representing a fundamentally different ecological setup. As in \autoref{sec:evol_outcome}, we use the original mutation mechanism with $p_\text{mut}=0.001$.
