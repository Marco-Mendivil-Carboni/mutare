...
% CHANGE THE FIGURE BELOW FOR ONE WITHOUT EVOLUTION

\begin{figure}
    \includegraphics{../sims/asymmetric/plots/strat_phe_0_i/rates.pdf}
    \caption{Extinction rate $r_\text{ext}$ versus mean growth rate $\langle \mu \rangle$ for ``fixed'' strategies, defining a Pareto front that captures the trade-off between growth and survival.} \label{fig:pareto_front}
\end{figure}
...
Note that all figures throughout this work include error bars and/or error bands; however, in many cases, they are smaller than the point symbols and are therefore barely visible.
