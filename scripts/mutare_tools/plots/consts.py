...
COL_TEX_LABELS: dict[str, str] = {
    ...
    "avg_strat_phe_0": "$\\bar{s}(A)$",
    "avg_avg_strat_phe_0": "$\\langle\\bar{s}\\rangle(A)$",
    "exp_avg_avg_strat_phe_0": "$\\langle\\bar{s}\\rangle(A)^\\ast$",
    "dist_avg_strat_phe_0": "$p(\\bar{s}(A))$",
    "exp_dist_avg_strat_phe_0": "$p(\\bar{s}(A))^\\ast$",
    "dist_phe_0": "$p(A)$",
